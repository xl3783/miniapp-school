var e = require("../../@babel/runtime/helpers/interopRequireDefault").default, t = require("../../utils/util"), a = new (e(require("../../utils/http")).default.Http)();
...
Component({
    ...
    methods: {
        lookImg: function(e) {
            var t = e.currentTarget.dataset, i = t.img, n = t.id;
