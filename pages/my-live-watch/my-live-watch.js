...
Page({
    data: (t = {
        ...
        durationtime: 0,
        currentTime: 0
    }, o(t, "pause", !0), o(t, "updateState", !0), o(t, "canClickLogin", !0), o(t, "score_list", 1), 
    o(t, "enroll_plan_list", 1), o(t, "score_style", 1), o(t, "enroll_plan_style", 1), 
    o(t, "enterObj", {}), o(t, "canGoTop", !1), t),
    handleRotate: function() {
        wx.navigateTo({
            url: "/pages/my-live-watch-rotate/my-live-watch-rotate?id=" + this.data.id + "&time=" + this.data.currenttime
        });
    },
    getHome: function() {
        var t = this;
        r.get(n.globalData.baseUrl + "/miniapp/home", {
            page: 1,
            page_size: 1
        }).then(function(e) {
            t.setData({
    ...
    onLoad: function(t) {
        ...
        wx.getSystemInfo({
            success: function(t) {
                var e = t.statusBarHeight, o = i + 2 * (s - e);
                a.setData({
                    statusBarHeight: e || 40,
                    customBar: o || 44
                });
            }
        }), this.getHome(), this.setData({
            id: t.id,
            isIphoneX: n.globalData.isIphoneX,
            ...
            score_list: n.globalData.score_list,
            enroll_plan_list: n.globalData.enroll_plan_list,
            score_style: n.globalData.score_style,
            enroll_plan_style: n.globalData.enroll_plan_style
    ...
    stateChange: function(t) {
        var e = this;
        -2301 == t.detail.code && this.playContext.stop({
            success: function() {
                e.playContext.play();
            },
            fail: function() {}
    ...
    getLiveDetail: function() {
        ...
        r.get(n.globalData.baseUrl + "/miniapp/live/" + this.data.id, {}, {
            ...
            if (0 == e.errcode) {
                ...
                t.getHistory();
                var a = e.name, o = e.cover_url, s = e.start_time, i = e.status, r = e.is_subscribe, l = e.rmtp_url, c = e.playback_url, p = e.duration, u = e.wssdomain, m = e.share_url, h = e.tab_list, d = e.view_num, g = e.images, f = e.ppt_playback;
                console.log(e);
                var v = [ {
                    image_url: "https://xiaopai-saas.oss-cn-hangzhou.aliyuncs.com/public/plan.png",
                    jump_url: "/pages/enroll-plan/enroll-plan",
                ...
                2 != i && (n.globalData.userInfo.token.access_token ? u && t.socketConnect() : wx.showToast({
                    title: "请去个人中心登陆",
                    icon: "none"
    ...
    socketConnect: function() {
        ...
        (e = wx.connectSocket({
            ...
            1012 == s.code && a.getRefreshToken()) : "0" != s.data.pptId && "" != s.data.pptId ? a.setData({
                ...
                var c = a.data.commentList;
                if (200 == s.code) c.push(a.data.tempMsg), a.setData({
                    commentList: c
                }), a.scrollToBottom(); else if ([ 2001, 2002 ].indexOf(s.code) > -1) c.push(s.data), 
                a.setData({
                    commentList: c
                }), a.scrollToBottom(); else if (2003 == s.code) {
                    var p = t.data.recordList;
                    c.push(s.data);
                    var u = {
                        title: s.data.msg,
                    ...
                    var m = t.data.recordList;
                    c.push(s.data);
                    var h = s.data.question.id;
                    m.map(function(t) {
                        t.id == h && (t.answer = s.data.msg);
                    }), a.setData({
                        commentList: c,
                        recordList: m
                    }), a.scrollToBottom();
                } else if (2005 == s.code) {
                    var d = t.data.recordList;
                    c.push(s.data);
                    var g = {
