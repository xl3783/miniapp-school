var e, t = require("../../@babel/runtime/helpers/interopRequireWildcard").default, a = require("../../@babel/runtime/helpers/interopRequireDefault").default, n = require("../../@babel/runtime/helpers/typeof"), r = a(require("./wx-canvas")), s = t(require("./echarts"));
...
Component({
    ...
    methods: {
        init: function(e) {
            var t = wx.getSystemInfoSync().SDKVersion, a = i(t, "2.9.0") >= 0, n = this.data.forceUseOldCanvas, r = a && !n;
            if (this.setData({
                isUseNewCanvas: r
            }), n && a && console.warn("开发者强制使用旧canvas,建议关闭"), r) this.initByNewWay(e); else {
                if (!(i(t, "1.9.91") >= 0)) return void console.error("微信基础库版本过低，需大于等于 1.9.91。参见：https://github.com/ecomfe/echarts-for-weixin#%E5%BE%AE%E4%BF%A1%E7%89%88%E6%9C%AC%E8%A6%81%E6%B1%82");
                console.warn("建议将微信基础库调整大于等于2.9.0版本。升级后绘图将有更好性能"), this.initByOldWay(e);
            }
        },
        initByOldWay: function(t) {
            ...
            wx.createSelectorQuery().in(this).select(".ec-canvas").boundingClientRect(function(e) {
                "function" == typeof t ? a.chart = t(n, e.width, e.height, 1) : a.data.ec && "function" == typeof a.data.ec.onInit ? a.chart = a.data.ec.onInit(n, e.width, e.height, 1) : a.triggerEvent("init", {
                    canvas: n,
                    width: e.width,
                    height: e.height,
                    canvasDpr: 1
        ...
        initByNewWay: function(e) {
            ...
            wx.createSelectorQuery().in(this).select(".ec-canvas").fields({
                ...
                var n = a[0].node;
                t.canvasNode = n;
                var i = wx.getSystemInfoSync().pixelRatio, c = a[0].width, o = a[0].height, h = n.getContext("2d"), u = new r.default(h, t.data.canvasId, !0, n);
                s.setCanvasCreator(function() {
                    return u;
